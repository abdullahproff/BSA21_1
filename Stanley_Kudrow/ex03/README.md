...
<table>
  ...
  <tr>
    ...
    <td>
      <ol>
        <li>Пользователь покинул страницу\экран выбора категорий без сохранения - категории сбрасываются без учёта их отметки в качестве выбранных. Таким образом при повторном входе всё заново.</li>

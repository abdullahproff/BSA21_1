...
-- Заполнение таблицы technicians
...
INSERT INTO inspections (inspection_id, defect_id, inspection_date, inspection_result, technician_id)
VALUES (3, 1, '2024-12-06', 'defect_confirmed', 2);

-- Вставка новой проверки с результатом "no_defect"
INSERT INTO inspections (inspection_id, defect_id, inspection_date, inspection_result, technician_id)
VALUES (4, 2, '2024-12-06', 'no_defect', 4);

-- Вставка новой проверки с результатом "repair_completed"
INSERT INTO inspections (inspection_id, defect_id, inspection_date, inspection_result, technician_id)
VALUES (5, 1, '2024-12-07', 'repair_completed', 1);

-- Проверка обновленных данных
SELECT r.rental_id, u.user_id, s.scooter_id, r.start_time, r.end_time, r.ride_status, r.payment_decision, dd.repair_status, s.operational_status, i.technician_id, t.name as technician_name
FROM rentals r
JOIN users u ON r.user_id = u.user_id
JOIN scooters s ON r.scooter_id = s.scooter_id
JOIN defect_descriptions dd ON s.defect_id = dd.defect_id
JOIN inspections i ON dd.defect_id = i.defect_id

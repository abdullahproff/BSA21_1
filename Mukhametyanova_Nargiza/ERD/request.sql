SELECT 
    ...
    baskets.basket_quantity AS Количество_товаров, -- Используем basket_quantity из таблицы baskets
    (products.product_cost * baskets.basket_quantity) AS Стоимость_товаров, -- Умножаем на basket_quantity
